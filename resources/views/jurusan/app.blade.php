    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="{{route ($role. '.jurusan.dashboard')}}" class="brand-logo text-white text-lg font-bold" style="text-decoration: none;">
                LabSI
            </a>
        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="" href="{{route ($role. '.jurusan.dashboard')}}" aria-expanded="false"><i
