...
<section class="is-title-bar py-3 border-bottom bg-white shadow-sm">
    <div class="d-flex justify-content-between align-items-center px-4">
        <div>
            ...
            <small class="text-muted">{{ ucfirst(Auth::user()->role) }} · Edit PC</small>
        </div>
    </div>
</section>
    ...
    <div class="max-w-lg mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        <header class="bg-gray-200 p-4">
            <div class="flex items-center">
                <h2 class="text-gray-800 text-l font-semibold ml-2">Edit PC</h2>
            </div>
        </header>
        <div class="card text-dark">
            <div class="card-header">
                <h4 class="card-title">Form Edit PC</h4>
            </div>
            <div class="card-body">
                <div class="basic-form">
                    <form action="{{ route($role . '.pc.update', $pc->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pc_name" class="form-control @error('pc_name') is-invalid @enderror"
                                   value="{{ old('pc_name', $pc->pc_name) }}" placeholder="Enter PC name" required>
                            @error('pc_name')
                        ...
                        <button type="submit" class="btn btn-outline-primary">
                            <i class="mdi mdi-content-save-edit"></i> Update PC
                        </button>
