...
<head>
  ...
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" href="{{asset('vendor/admin-one/dist/css/bootstrap.min.css')}}">
...
<aside class="aside is-placed-left is-expanded">
  ...
  <div class="menu is-menu-main">
    ...
    <ul class="menu-list">
      <li class="{{ Request::routeIs($role . '.teknisi.dashboard') ? 'active' : '' }}">
        <a href="{{ route($role . '.teknisi.dashboard') }}">
