            ...
            <table class="table table-bordered text-dark">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if(in_array($report->status, ['Broken', 'Suggested', 'Reviewed']))
                    ...
                    <div class="modal fade" id="editModal-{{ $report->id }}" tabindex="-1" role="dialog">
                        <div class="modal-dialog" role="document">
                            <form method="POST" action="{{ route('teknisi.labreport.updateteknisi', $report->id) }}">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div class="modal-body text-dark">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-control" name="status" required>
                                                <option value="Broken" {{ $report->status === 'Broken' ? 'selected' : '' }}>Broken</option>
                                                <option value="Not Resolved" {{ $report->status === 'Not Resolved' ? 'selected' : '' }}>Not Resolved</option>
